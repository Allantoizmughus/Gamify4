...
public class SimpleItemTouchHelperCallback extends ItemTouchHelper.Callback {
    ...
    //  which will eventually handle updating the games ArrayList to reflect the item's new position.
    @Override
    ...
    //  which will eventually handle deleting this item from the user's "Saved Games" in Firebase.
